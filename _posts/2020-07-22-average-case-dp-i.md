---
layout: post
title: The Pitfalls of Average-Case DP (Part I)
comments: true
authors: 
    - thomassteinke 
    - jonullman
...
So, is there are role for distributional assumptions in differential privacy?  Yes! Although we've discussed the pitfalls of making the privacy guarantee contingent on distributional assumptions, none of these pitfalls apply to making the *utility guarantee* contingent on distributional assumptions, as is normally done in statistical analysis.  In recent years, this combination---worst-case privacy, average-case utility---has been fruitful, and seems to allow many of the benefits that average-case privacy definitions seek to capture.  For example, allowing mean and covariance estimation of unbounded data under natural modeling assumptions [**[KV18]**](https://arxiv.org/abs/1711.03908), [**[KLSU19]**](https://arxiv.org/abs/1805.00216), [**[BS19]**](https://arxiv.org/abs/1906.02830), [**[DFMBG20]**](https://arxiv.org/abs/2001.02285), [**[KSU20]**](https://arxiv.org/abs/2002.09464), [**[BDKU20]**](https://arxiv.org/abs/2006.06618), but, this remains an active and open area of research.

---

[1] For example, there are approaches based on various paradigms like Smooth Sensitivity [**[NRS07]**](http://www.cse.psu.edu/~ads22/pubs/NRS07/NRS07-full-draft-v1.pdf) [**[BS19]**](https://arxiv.org/abs/1906.02830), Propose-Test-Release [**[DL09]**](http://www.stat.cmu.edu/~jinglei/dl09.pdf), or Truncation/Winsorization [**[S11]**](http://www.cse.psu.edu/~ads22/pubs/2011/stoc194-smith.pdf) [**[KV18]**](https://arxiv.org/abs/1711.03908) [**[KLSU19]**](https://arxiv.org/abs/1805.00216) [**[KSU20]**](https://arxiv.org/abs/2002.09464) to name a few.
