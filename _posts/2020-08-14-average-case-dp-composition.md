...
The employer may find out that 417 employees have condition X.  That's OK; on its own, this number reveals very little about whether or not *you* have condition X, as long as your employer is uncertain about how many employees *other than you* have ccondition X.  We can formalize this as some kind of average-case or Bayesian privacy guarantee. Thus the health-insurance company is comfortable releasing this number exactly.  But, yesterday, before you started your job, it also seemed reasonable to allow your employer to ask the exact same question, and yesterday the answer was 416. Thus your employer concludes that you have condition X. 
