...
If we want to eliminate the failure probability, we could use _truncated_ Laplace noise instead of regular Laplace noise. And -- spoiler alert -- that's the kind of method we're going to look at.
